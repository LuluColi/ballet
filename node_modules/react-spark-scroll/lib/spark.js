...
function sparkFactory(_ref4) {
  ...
  var sparkFormulas = formulas ? assign({}, _sparkFormulas, formulas) : _sparkFormulas;
  var sparkActionProps = actionProps ? assign({}, _sparkActionProps, actionProps) : _sparkActionProps;
  var sparkSetup = setup ? assign({}, _sparkSetup, setup) : _sparkSetup;
  ...
  spark.cleanup = function () {
    return eventEmitter.emit('cleanup');
  };
