      ...
      <div className="App">
                ...
                {matches => (
                  matches
                    ? <div className="home-text">
                        <img className="" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/main_title.svg" alt="芭蕾建築" />
                      </div>
                    : <SparkScroll.div
                          className="home-text"
                          style={titleOpacity}
                          proxy="pin-cont"
                          timeline={{
                            'topTop': { transform: "translateY(5%)", opacity: 0 },
                            'topTop+1': { transform: "translateY(30%)", opacity: 1 }
                          }} >
                        <img className="" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/main_title.svg" alt="芭蕾建築" />
                      </SparkScroll.div>
                )}
            ...
            {matches => (
              matches 
                ?  <div className="page dark">
                    <div className="container cmobile">
                      <div className="content">
            ...
            {matches => (
              matches
                ? <div className="cover_mobile">
                    <img className="mobile_bg" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/mobilebg1.jpg" alt="芭蕾建築" />
                    <img className="mobile_bg" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/mobilebg2.jpg" alt="芭蕾建築" />
                  </div>
        ...
        <Media query={MOBILE}>
            {matches => (
              matches 
                ?  <div className="page dark">
                    <div className="container cmobile">
                      <div className="content">
                        <div className="container relative">
                          <div className="text">
                            <img className="" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/title2.svg" alt="發現" />
                          </div>
                          <div className="text white">
                ...
                :  <div className="page dark" style={styleBg2}>
        ...
        <Media query={MOBILE}>
            {matches => (
              matches
                ? <div className="cover_mobile">
                    <img className="mobile_bg" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/mobilebg3.jpg" alt="芭蕾建築" />
                    <img className="mobile_bg" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/mobilebg4.jpg" alt="芭蕾建築" />
                  </div>
        ...
        <Media query={MOBILE}>
            {matches => (
              matches 
                ...
                :  <div className="page dark" style={styleBg3}>
                    <div className="container transbg">
                      <div className="content">
                        <div className="container relative">
                          <div className="text">
        ...
        <Media query={MOBILE}>
            {matches => (
              matches
                ? <div className="cover_mobile">
                    <img className="mobile_bg" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/mobilebg5.jpg" alt="芭蕾建築" />
                    <img className="mobile_bg" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/mobilebg6.jpg" alt="芭蕾建築" />
                  </div>
        ...
        <Media query={MOBILE}>
            {matches => (
              matches 
                ?  <div className="page dark">
                    <div className="container cmobile">
                      <div className="content">
                        <div className="container relative">
                          <div className="text">
                            <img className="" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/title4.svg" alt="發現" />
                          </div>
                          <div className="text white">
                ...
                :  <div className="page dark" style={styleBg4}>
                    <div className="container transbg">
                      <div className="content">
                        <div className="container relative">
                          <div className="text">
        ...
        <Media query={MOBILE}>
            {matches => (
              matches
                ? <div className="cover_mobile">
                    <img className="mobile_bg" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/mobilebg7.jpg" alt="芭蕾建築" />
                    <img className="mobile_bg" src="https://initium-style.s3.amazonaws.com/StylishFeature/20170331/mobilebg8.jpg" alt="芭蕾建築" />
                  </div>
